...
import {login, getUserId, getUserInfo, logout, register} from '@/api/api.ts'
...
<template>
  <header class="fixed top-0 left-0 w-full h-16 z-50 bg-white/80 backdrop-blur-md shadow-md flex items-center px-6 justify-between">
    <router-link to="/" class="flex items-center space-x-2 pb-2">
      <el-image src="public/logo-1.png" class="w-10 h-10 rounded-full border-2 border-gray-300"/>
    ...
    <div class="flex items-center space-x-4 pb-2">
      ...
      <template v-else>
        <el-avatar size="default" class="!rounded-full" :src="userInfo.avatar"/>
        <el-dropdown>
  ...
  <el-dialog v-model="handleLogin" title="登录" width="30%">
    <el-form :model="loginDialog">
      ...
      <el-form-item label="密码">
        <el-input v-model="loginDialog.password" type="password" placeholder="请输入密码"></el-input>
      </el-form-item>
    </el-form>
    <div>
  ...
  >
    ...
    >
      ...
      <el-form-item label="头像" prop="avatar">
        ...
        >
          <div class="w-32 h-32 rounded-full border-2 border-dashed border-gray-300 hover:border-blue-500 transition-colors flex items-center justify-center overflow-hidden">
